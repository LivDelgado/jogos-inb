...
levelOne.prototype = {
	...
	update: function (){
		...
		game.physics.arcade.collide(player, lixoVerde, this.colete, null, this);
		game.physics.arcade.collide(player, lixoVermelho, this.morra, null, this);
	...
	colete: function (){game.state.start('levelTwo')},
